...
namespace Main.Controllers
{
    ...
    public class HousingController : Controller
    {
        ...
        public HousingController(ILogger<HousingController> logger, IConfiguration config, IHousingAPI attom,
        ...
        {
            //Need more research as to how I can display the picture. Might be able to just place the url
